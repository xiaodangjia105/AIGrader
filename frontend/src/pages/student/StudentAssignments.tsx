...
import { Card, Button, Tag, List, Spin, message } from 'antd';
          ...
          <Card style={{ marginBottom: 12 }} size="small">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <Tag style={{ marginLeft: 8 }} color={a.status === 'ACTIVE' ? 'blue' : 'green'}>{a.status}</Tag>
                <span style={{ color: '#888', marginLeft: 12 }}>Due: {a.dueDate?.split('T')[0]}</span>
              </div>
